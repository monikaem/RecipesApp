            ...
            <div className='form-container'>
                <form>
                    ...
                    <div className='form-control'>
                        ...
                        <input type='text' name='title' value={recipes[editID].title} onChange={handleChange} id='title'/>
                    </div>
                    <div className='form-control'>
                        <label htmlFor='img'>Image URL: </label>
                        <input type='text' name='img' value={recipes[editID].img} onChange={handleChange} id='img'/>
                    </div>
                    <div className='form-control'>
                        <label htmlFor='notes'>Your notes: </label>
                        <input type='text' name='notes' value={recipes[editID].notes} onChange={handleChange} id='notes'/>
                    </div>
